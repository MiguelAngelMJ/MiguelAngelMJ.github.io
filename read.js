...
function add(r,o,t,c,n,i,e,b,d,a,p){var s=L.marker([o,t],{icon:userIcon,rotationAngle:c-90}).addTo(AIS);s.bindPopup("<table><tr><th>DATOS AIS</th></tr><tr><td><b>Mmsi:  </b>"+[r]+"</td></tr><tr><td><b>Latitude:  </b>"+[o]+"</td></tr><tr><td><b>Longitude:  </b>"+[t]+"</td></tr><tr><td><b>Course:  </b>"+[c]+"</td></tr><tr><td><b>Speed:  </b>"+[n]+"</td></tr><tr><td><b>Heading:  </b>"+[i]+"</td></tr><tr><td><b>Timestamp:  </b>"+[e]+"</td></tr><tr><td><b>Name:  </b>"+[b]+"</td></tr><tr><td><b>Imo:  </b>"+[d]+"</td></tr><tr><td><b>ShipType:  </b>"+[a]+"</td></tr><tr><td><b>Callsign:  </b>"+[p]+"</td></tr></table>",customOptions),mark.push(s)}switch(shiptpe){case 80:userIcon=L.icon({iconUrl:"GISMAR/AIS/ICONOS/bTanquero",iconSize:[27,25],iconAnchor:[20,10],popupAnchor:[-3,-20]});break;case 30:userIcon=L.icon({iconUrl:"GISMAR/AIS/ICONOS/bPesca",iconSize:[27,25],iconAnchor:[20,10],popupAnchor:[-3,-20]});break;case 37:userIcon=L.icon({iconUrl:"GISMAR/AIS/ICONOS/bTuristico",iconSize:[27,25],iconAnchor:[20,10],popupAnchor:[-3,-20]});break;case 51:userIcon=L.icon({iconUrl:"GISMAR/AIS/ICONOS/bSar",iconSize:[27,25],iconAnchor:[20,10],popupAnchor:[-3,-20]});break;case 60:userIcon=L.icon({iconUrl:"GISMAR/AIS/ICONOS/bPasajeros",iconSize:[27,25],iconAnchor:[20,10],popupAnchor:[-3,-20]});break;default:userIcon=L.icon({iconUrl:"GISMAR/AIS/ICONOS/b",iconSize:[27,25],iconAnchor:[20,10],popupAnchor:[-3,-20]})}
function del(i) {
